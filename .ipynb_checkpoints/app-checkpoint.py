...
st.markdown("""
<style>
    .stApp { background-color: #0a0a0a; color: #ddd; }
    #MainMenu {visibility: hidden;} footer {visibility: hidden;} header {visibility: hidden;}
    .result-card { background: #111; border: 1px solid #222; border-radius: 10px; padding: 10px; }
    .prediction-text { font-size: 1.4rem; text-align:center; }
    .prob { text-align:center; color:#999; font-family: monospace; }
</style>
